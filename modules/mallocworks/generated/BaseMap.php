...
abstract class BaseMap extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('src_model', 'enum', null, array('type' => 'enum', 'values' => array(0 => 'PAGE', 1 => 'TEMPLATE', 2 => 'FORM', 3 => 'SUBSCRIBER', 4 => 'CATEGORY', 5 => 'WALL', 6 => 'RESOURCE', 7 => 'EMAIL', 8 => 'ANNOUNCEMENT'), 'notnull' => true));
        $this->hasColumn('tgt_model', 'enum', null, array('type' => 'enum', 'values' => array(0 => 'PAGE', 1 => 'TEMPLATE', 2 => 'FORM', 3 => 'SUBSCRIBER', 4 => 'CATEGORY', 5 => 'WALL', 6 => 'RESOURCE', 7 => 'EMAIL', 8 => 'ANNOUNCEMENT'), 'notnull' => true));
