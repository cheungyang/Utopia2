 ...
 * @property clob $mailto
 * @property clob $mailcc
 * @property clob $mailbcc
 * @property clob $title
...
abstract class BaseEmail extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('mailfrom', 'string', 50, array('type' => 'string', 'notnull' => true, 'length' => '50'));
        $this->hasColumn('mailto', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('mailcc', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('mailbcc', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('title', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('content', 'clob', null, array('type' => 'clob', 'notnull' => true));
