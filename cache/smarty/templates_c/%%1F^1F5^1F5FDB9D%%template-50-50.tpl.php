<?php /* Smarty version 2.6.25, created on 2009-06-07 20:27:37
...
unset($_smarty_tpl_vars);
 ?>    
    ...
    <div class="span-24 last posbase">
      <img src="<?php echo $this->_tpl_vars['WEB_FILES_ROOT']; ?>
img/<?php echo $this->_tpl_vars['page']['3']; ?>
" class="resize"/>
      <div class="span-6 last white posright allheight">
        <br/><br/><br/><p class="para"><?php echo $this->_tpl_vars['page']['6']; ?>
</p>
      </div>
    </div>
