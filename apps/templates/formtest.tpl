...
<head>
  ...
  <!-- Framework CSS -->
	<link rel="stylesheet" href="{$DIR_CSS_ROOT}vendor/blueprint/screen.css" type="text/css" media="screen, projection">
	<link rel="stylesheet" href="{$DIR_CSS_ROOT}vendor/blueprint/print.css" type="text/css" media="print">
  <!--[if lt IE 8]><link rel="stylesheet" href="{$DIR_CSS_ROOT}vendor/blueprint/ie.css" type="text/css" media="screen, projection"><![endif]-->
