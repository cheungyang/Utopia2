 ...
 * @property clob $preprocess
 * @property clob $structure
 * @property clob $process
 * @property clob $view
 * @property enum $cult
 ...
 */
abstract class BaseForm_version extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('form_version');
        ...
        $this->hasColumn('preprocess', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('structure', 'clob', null, array('type' => 'clob', 'notnull' => true));
        $this->hasColumn('process', 'clob', null, array('type' => 'clob', 'notnull' => true));
