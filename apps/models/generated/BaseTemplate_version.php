 ...
 * @property clob $templateview
 * @property clob $view
 * @property clob $controller
 * @property clob $structure
 * @property enum $cult
 ...
 */
abstract class BaseTemplate_version extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('template_version');
        ...
        $this->hasColumn('templateview', 'clob', null, array('type' => 'clob', 'notnull' => true));
        ...
        $this->hasColumn('structure', 'clob', null, array('type' => 'clob', 'notnull' => true));
