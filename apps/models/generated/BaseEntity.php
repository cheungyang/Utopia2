 ...
 * @property Doctrine_Collection $Resource_version
...
abstract class BaseEntity extends Doctrine_Record
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('property', 'enum', null, array('type' => 'enum', 'values' => array(0 => 'MALLOCWORKS', 1 => 'WILGRIST'), 'notnull' => true));
        $this->hasColumn('model', 'enum', null, array('type' => 'enum', 'values' => array(0 => 'USER', 1 => 'SUBSCRIBER', 2 => 'PERMISSION', 3 => 'CATEGORY', 4 => 'PGROUP', 5 => 'PAGE', 6 => 'TEMPLATE', 7 => 'FORM', 8 => 'WALL', 9 => 'RESOURCE', 10 => 'EMAIL', 11 => 'ANNOUNCEMENT'), 'notnull' => true));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Subscriber', array('local' => 'id',
                                           'foreign' => 'entity_id'));

        $this->hasMany('Permission', array('local' => 'id',
                                           'foreign' => 'entity_id'));

        $this->hasMany('Category', array('local' => 'id',
                                         'foreign' => 'entity_id'));
        ...
        $this->hasMany('Wall', array('local' => 'id',
                                     'foreign' => 'entity_id'));

        $this->hasMany('Resource', array('local' => 'id',
                                         'foreign' => 'entity_id'));

        $this->hasMany('Resource_version', array('local' => 'id',
                                                 'foreign' => 'entity_id'));

        $this->hasMany('Email', array('local' => 'id',
                                      'foreign' => 'entity_id'));

        $this->hasMany('Announcement', array('local' => 'id',
                                             'foreign' => 'entity_id'));
